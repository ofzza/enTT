...
describe('class EnTT', () => {
    it('Initializes enTT metadata namespaces on extending classes and instances', () => {
        ...
        tests_init_1.assert(internals_1._getInstanceMetadata(nonEnTT) !== undefined);
        tests_init_1.assert(internals_1._getClassMetadata(nonEnTT.constructor) !== undefined);
        ...
        tests_init_1.assert(internals_1._getInstanceMetadata(initializedEnTT) !== undefined);
        tests_init_1.assert(internals_1._getClassMetadata(initializedEnTT.constructor) !== undefined);
    });
